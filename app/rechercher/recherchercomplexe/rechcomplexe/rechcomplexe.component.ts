...
@Component({
  selector: 'app-rechcomplexe',
  templateUrl: './rechcomplexe.component.html',
  styleUrls: ['./rechcomplexe.component.css']
})
export class RechcomplexeComponent implements OnInit {

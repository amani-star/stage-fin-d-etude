...
@Component({
  selector: 'app-rechercheclasspatient',
  templateUrl: './rechercheclasspatient.component.html',
  styleUrls: ['./rechercheclasspatient.component.css']
})
export class RechercheclasspatientComponent implements OnInit {

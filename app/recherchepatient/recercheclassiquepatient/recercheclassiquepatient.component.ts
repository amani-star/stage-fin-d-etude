...
@Component({
  selector: 'app-recercheclassiquepatient',
  templateUrl: './recercheclassiquepatient.component.html',
  styleUrls: ['./recercheclassiquepatient.component.css']
})
export class RecercheclassiquepatientComponent implements OnInit {
  listeType: any;
  selectedOption: any;
  prixmax:any;
  prixmin:any;

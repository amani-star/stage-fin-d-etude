...
@Component({
  selector: 'app-recherchersimplepatient',
  templateUrl: './recherchersimplepatient.component.html',
  styleUrls: ['./recherchersimplepatient.component.css']
})
export class RecherchersimplepatientComponent implements OnInit {

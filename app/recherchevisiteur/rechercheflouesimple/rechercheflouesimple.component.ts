...
@Component({
  selector: 'app-rechercheflouesimple',
  templateUrl: './rechercheflouesimple.component.html',
  styleUrls: ['./rechercheflouesimple.component.css']
})
export class RechercheflouesimpleComponent implements OnInit {
  selectlogement: any;
  selectedOption: any;
  listeType: any;
  prix: any;

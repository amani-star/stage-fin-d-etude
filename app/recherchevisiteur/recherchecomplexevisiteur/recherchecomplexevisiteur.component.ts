...
@Component({
  selector: 'app-recherchecomplexevisiteur',
  templateUrl: './recherchecomplexevisiteur.component.html',
  styleUrls: ['./recherchecomplexevisiteur.component.css']
})
export class RecherchecomplexevisiteurComponent implements OnInit {
  listeType: any;
  selectedOption="";
  selectlogement="";
